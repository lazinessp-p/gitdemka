...
import com.example.gifts.exception.EmptyGiftException;
...
public class DataGenerator {
    ...
    public static Sweet[] generate(int count) throws EmptyGiftException {
        if (count <= 0) {
            throw new EmptyGiftException("Ошибка генерации: количество сладостей должно быть больше 0 (передано: " + count + ")");
        }
        ...
        for (int i = 0; i < count; i++) {
            ...
            try {
                ...
                throw new EmptyGiftException("Ошибка при создании объекта сладости на позиции " + i);
            }
        }
        return sweets;
    }
